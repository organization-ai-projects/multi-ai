/// Ce fichier implémente un explorateur méta (`MetaExplorer`).
/// Rôle : Gérer une population de génomes (`StrategyGenome`) et appliquer des mécanismes d'évolution pour optimiser des stratégies complexes.
...
impl MetaExplorer {
    ...
    pub fn reproduce(&mut self, pop_size: usize) {
        ...
        while new_pop.len() < pop_size {
            ...
            // Ajout de la logique de mutation
            if rand::random::<f32>() < 0.1 {
                println!("Mutation d’une stratégie de parsing !");
                // Swap parser, randomise le selector, ajoute une nouvelle stratégie, etc.
