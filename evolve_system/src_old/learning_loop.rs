/// Ce fichier implémente une boucle d'apprentissage (`LearningLoop`).
/// Rôle : Apprendre de nouveaux concepts en utilisant un graphe (`Graph`) et un index vectoriel (`VectorIndex`), et sauvegarder ou charger l'état.
